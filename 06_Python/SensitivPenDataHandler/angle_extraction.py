...
"""
Program that extract statistical features of the angle of the pen.
"""
...
stationary_psi = sensitivPenDataSet.psi[index_init:index_end]
stationary_theta = sensitivPenDataSet.theta[index_init:index_end]
